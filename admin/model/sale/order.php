...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		// Avash
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.vendor_id, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
		...
		if (!empty($data['vendor_id']) && (int)$data['vendor_id'] != 0) {
			$sql .= " AND o.vendor_id = '" . (int)$data['vendor_id'] . "'";
		}
